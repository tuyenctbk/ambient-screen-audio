...
![AetherScreen Google Play Store App Icon](./aetherscreen_app_icon.png)
...
![AetherScreen Google Play Store Feature Graphic](./aetherscreen_feature_graphic.png)
...
*   **Screenshot 8: Tablet Main Dashboard**
    *   Text: *"Widescreen control layout for display dimming & touch locks"*
    ![Tablet Dashboard](./tablet_screenshot_onboarding1.png)
*   **Screenshot 9: Tablet Settings & Triggers**
    *   Text: *"Setup proximity sensor triggers & sleep timers"*
    ![Tablet Settings](./tablet_screenshot_settings.png)
